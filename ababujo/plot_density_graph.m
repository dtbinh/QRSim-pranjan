...
plot_network_density(results_pe, results_pe_up, results_flooding, drone_count_arr, pair_ct, number_iterations);

function plot_network_density(results_pe, results_pe_up, results_flooding, drone_ct_arr, pair_ct, iter_ct)
global single_figure;
fontsize = 14;
leg_font_size = 13;
x = drone_ct_arr;
