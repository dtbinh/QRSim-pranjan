classdef State<handle
    ...
    properties (Access=public)
        ...
        send_plume_detected = 1 % pranjan. Should a drone Send a plume detected message? 0=NO, 1= Yes
        send_coordinates = 0 % pranjan. Each drone shall advertise it's x,y,z coordinates
    end
end
