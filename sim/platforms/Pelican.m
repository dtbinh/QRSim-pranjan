        ...
        function obs = obstacleCheck(obj)
            ...
            for i = 1: length(obj.simState.platforms),
                for j = 1: size(obj.obstacles,2)
                    ...
                    ry = [obj.obstacles(2,j); (obj.obstacles(2,j) + obj.obstacles(4,j))];
                    if((((obj.simState.platforms{i}.X(1) - lx(1))^2 + (obj.simState.platforms{i}.X(2) - lx(2))^2)^0.5< obj.collisionD)||(((obj.simState.platforms{i}.X(1) - ly(1))^2 + (obj.simState.platforms{i}.X(2) - ly(2))^2)^0.5< obj.collisionD) || (((obj.simState.platforms{i}.X(1) - rx(1))^2 + (obj.simState.platforms{i}.X(2) - rx(2))^2)^0.5< obj.collisionD)|| (((obj.simState.platforms{i}.X(1) - ry(1))^2 + (obj.simState.platforms{i}.X(2) - ry(2))^2)^0.5< obj.collisionD))
                        obs = 1;
